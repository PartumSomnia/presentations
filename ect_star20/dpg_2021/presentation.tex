...
\titlegraphic{\vspace{-2.2cm}\includegraphics[width=.35 \textwidth, right]{./figs/Core.png}}
...
%TODO FIX THE PLOT WITH GRB ASCENCI PLOT -- IT SEESM TO BE CUT

\section{Introduction}
\input{Slides/Introduction}
\section{NR simulations}
\input{Slides/Simulations}
\section{Ejecta \& Kilonova}
\input{Slides/SecEjectaKilonova}
\section{Ejecta \& Afterflow}
\input{Slides/DynEjAfterglow}
\section{Conclusion}
