...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-2.9cm,1.3cm)}]current page.center){
        \parbox{0.70\textwidth}{
            ...
            \begin{itemize}
            \item A Trace physics of jet formation.
            \item Gives information on the fastest ejecta.
            \end{itemize}
    }};
}
...
\uncover<2->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-2.9cm,-2.0cm)}]current page.center){
        \parbox{0.70\textwidth}{
            ...
            \begin{itemize}
            \item continous follow-up observations.
...
\uncover<3->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.6cm,-3.7cm)}]current page.center){
        \parbox{0.60\textwidth}{
            Emierging component. Kilonova afterglow?
    }};
}
...
\begin{frame}{Kilonova afterglow for \GRB{} rebrightening$^{\text{\citep{Hajela:2021faz,Nedora:2021eoj}}}$} %% ---------- title 
\begin{tikzpicture}[overlay,remember picture]
