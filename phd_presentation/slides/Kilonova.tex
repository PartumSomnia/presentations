...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.8cm,1.3cm)}]current page.center){
        \parbox{0.56\textwidth}{
            ...
            powered by the decay of synthesized elements\footcite{Paczynski:1993gz,Metzger:2016pju}.%$^{\textcolor{gray}{\text{\cite{Paczynski:1993gz,Metzger:2016pju}}}}$. \\
            \\
            
            Nuclear heating rate, $\varepsilon_{\rm nuc}\propto t^{-\alpha}$. \\
...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.6cm,-1.5cm)}]current page.center){
        \parbox{0.60\textwidth}{
            \textbf{\AT{}}, counterpart to \GW{}\footcite{Villar:2017wcc}.%$^{\textcolor{gray}{\text{\cite{Villar:2017wcc}}}}$ \\
            
            Two spatially distinct components\footcite{Kasen:2017sxr,Perego:2017wtu}:%$^{\textcolor{gray}{\text{\cite{Kasen:2017sxr}}}}$:
            \begin{itemize}
...
\uncover<2->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(4.0cm,-3.6cm)}]current page.center){
        \parbox{0.50\textwidth}{
            Can \swind{} help explaining early \textcolor{blue}{"blue"} emission?
%            \begin{itemize}
...
\uncover<3->{ % <-> |
    \node (img1) [anchor=center,scale=1,opacity=1] at ([shift={(4.5cm,-0.1cm)}]current page.center){
        \parbox{0.45\textwidth}{
            \includegraphics[height=4.8cm]{phd_figs/mkn__albino2.pdf} \\
            \textbf{Model}: multicomponent, anisotropic semi-analytical. \texttt{MKN} code.%\footcite{Perego:2017wtu}%$^{\textcolor{gray}{\text{\cite{Perego:2017wtu}}}}$\\ 
...
\begin{frame}{Spiral-wave wind for the blue kilonova\footcite{Nedora:2019jhl,Nedora:2020pak}}%$^{\text{\textcolor{gray}{\cite{Nedora:2019jhl,Nedora:2020pak}}}}$} %% ---------- title 
...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-0.8cm,2.2cm)}]current page.center){
        \parbox{1.0\textwidth}{
            \begin{itemize}
            \item Dynamical ejecta cannot explain early blue emission.
            \item Winds probe remnant dynamics, lifetime and EOS.
            \end{itemize}
    }};
}
...
\uncover<2->{ % <-> |
    \node (img1) [anchor=center,scale=1,opacity=1] at ([shift={(-4.0cm,-1.2cm)}]current page.center){
        \parbox{0.5\textwidth}{
            \includegraphics[height=5.5cm]{phd_figs/ejecta_dyn/summary/ej_mej_yeej_our2.pdf}
    }};
}

\uncover<1->{ % <-> |
    \node (img1) [anchor=center,scale=1,opacity=1] at ([shift={(2.6cm,-1.2cm)}]current page.center){
        \parbox{0.5\textwidth}{
            \includegraphics[height=6.0cm]{phd_figs/kilonova/mkn_dd2_band.pdf}
    }};
}
