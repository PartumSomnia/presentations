...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.8cm,1.3cm)}]current page.center){
        \parbox{0.56\textwidth}{
            \textbf{Kilonova} (kN) -- thermal EM counterpart to mergers, 
...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.6cm,-1.5cm)}]current page.center){
        \parbox{0.60\textwidth}{
            ...
            Two spatially disticnt components$^{\textcolor{gray}{\text{\cite{Kasen:2017sxr}}}}$:
            \begin{itemize}
            \item low $\kappa$ -- early "blue" peak,
            \item high $\kappa$ -- late "red" peak.
            \end{itemize}
    }};
}
...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.6cm,-3.5cm)}]current page.center){
        \parbox{0.60\textwidth}{
            \textbf{Issue:} insufficient ejecta to explain early "blue" \ac{kN}.
%            \begin{itemize}
