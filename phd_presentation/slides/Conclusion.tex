...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-0.0cm,1.0cm)}]current page.center){
        \parbox{1.1\textwidth}{
            ...
            \item \textbf{Kilonova afterglow} in x-ray band is comaptable with latest observations (weakrly) constraining binary parameters to moderately soft \ac{EOS} and mass ratio ${\gtrsim}1$.
