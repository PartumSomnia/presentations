...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.5cm,1.3cm)}]current page.center){
        \parbox{0.65\textwidth}{
            \begin{itemize}
                \item Synchrotron emission arising when ejecta moves through ISM$^{\textcolor{gray}{\text{\cite{Sari:1997qe}}}}$
                \item \GRB{} afterglow, structured jet, off-axis$^{\textcolor{gray}{\text{\cite{Hajela:2019mjy}}}}$
                \item expected kN ejecta afterglow$^{\textcolor{gray}{\text{\cite{Kathirgamaraju:2019xwu}}}}$
            \end{itemize}
    }};
}
...
\uncover<1->{ % <-> |
    \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-3.5cm,-2.0cm)}]current page.center){
        \parbox{0.60\textwidth}{
            \GRB{} \textbf{x-ray light curve changed} $1243$ days post-merger. 
            Possible explanations$^{\textcolor{gray}{\text{\cite{Hajela:2021faz}}}}$: 
            \begin{itemize}
...
\begin{frame}{Model: dynamics}  %% ---------- Intro/motivation 
    \begin{tikzpicture}[overlay,remember picture]
        \uncover<1->{ % <-> |
            \node (t1) [anchor=center,scale=1,opacity=1] at ([shift={(-0.6cm,-0.4cm)}]current page.center){
                \parbox{1.\textwidth}{
