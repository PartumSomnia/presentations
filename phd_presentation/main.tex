...
\usepackage[
backend=bibtex,
style=authoryear-comp,%authoryear-comp,
natbib=true,
sorting=debug,
maxnames=1,
uniquelist=true
]{biblatex}%biblatex
\addbibresource{references} % references for the thesis % ../phd_thesis/references
...
%    \color{gray}\mybibitem{#1}
%}

% \graphicspath{{/home/vsevolod/Work/GIT/GitHub/phd_thesis/v3/Figures/}} % /home/vsevolod/Work/GIT/GitHub/phd_thesis/v3/Figures/

\usepackage{hyperref}
\usepackage{cleveref}
\crefformat{footnote,color=gray}{#2\footnotemark[#1]#3}
...
\setbeamercolor{footnote}{fg=gray} % CHANGES color for footnote!
...
% Figure of the CoRe collaboration
