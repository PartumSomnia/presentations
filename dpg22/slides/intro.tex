...
%                    \end{itemize}
        ...
        \uncover<1-2>{ % <-> |
        \node (img1) [anchor=center,scale=1,opacity=1] at ([shift={(-2.6cm,-1.85cm)}]current page.center){
            \parbox{0.5\textwidth}{
        ...
        \uncover<2-2>{ % <-> |
            \node (img1) [anchor=center,scale=1,opacity=1] at ([shift={(4.5cm,-2.12cm)}]current page.center){
                \parbox{0.6\textwidth}{
                    \includegraphics[height=4.21cm]{figures/best_radio_obs_representative_all_eos.pdf}
